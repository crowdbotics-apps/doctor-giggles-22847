"""doctor_giggles_22847 URL Configuration
...
admin.site.site_header = "Doctor Giggles"
admin.site.site_title = "Doctor Giggles Admin Portal"
admin.site.index_title = "Doctor Giggles Admin"

# swagger
api_info = openapi.Info(
    title="Doctor Giggles API",
    default_version="v1",
    description="API documentation for Doctor Giggles App",
)
